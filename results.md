...
| Token Mixer | Kernel Size | Dataset | S12 ACC, AUC, F1       | S24 ACC, AUC, F1       | S36 ACC, AUC, F1       |
|-------------|-------------|---------|------------------------|------------------------|------------------------|
| sep_conv    | 3           | Derma   | 0.7138, 0.8867, 0.7029 | 0.7048, 0.8745, 0.7136 | 0.7064, 0.8742, 0.717  |
| random      | -           | Derma   | 0.707, 0.9024, 0.723   | 0.6766, 0.8673, 0.7059 | 0.6782, 0.8456, 0.6914 |
| pooling     | 7           | Path    | 0.903, 0.9829, 0.8986  | 0.9085, 0.982, 0.9027  | 0.8935, 0.9823, 0.8934 |
| conv        | 7           | Path    | 0.9115, 0.9887, 0.9112 | 0.8968, 0.9851, 0.897  | 0.9136, 0.9877, 0.9151 |

### 3D extension

| Token Mixer   | Kernel Size | NoduleMNIST3D (Classification) ACC, AUC, F1 | AbdomenAtlas (Segmentation) Dice, HD95 |
|---------------|-------------|---------------------------------------------|----------------------------------------|
...
|               | 9           | -              | -               | 0.5639, 549.7401          |
| Rad DINO      | -           | 0.9424, 9.6545 | 0.5216, 20.9586 | 0.5734, 535.4161          |

## S24 Variant on AbdomenAtlas

| Token Mixer | Kernel Size | S12 Dice, HD95 | s24 Dice, HD95 | s36 Dice, HD95 |
|-------------|-------------|----------------|----------------|----------------|
| pooling     | 3           | 0.9405, 3.2336 | 0.941, 2.7472  | 0.9386, 3.0162 |
| sep_conv    | 3           | 0.9379, 3.0115 | 0.9454, 3.0828 | 0.9431, 2.9224 |
