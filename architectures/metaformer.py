# taken from https://github.com/sail-sg/poolformer/blob/main/models/metaformer.py#L223
...
def metaformer_ppaa_s12_224(pretrained=False, **kwargs):
    ...
    add_pos_embs = [None, None, 
        partial(AddPositionEmb, spatial_shape=[14, 14]), partial(AddPositionEmb, spatial_shape=[7, 7])] # added second pos embedding due o mismatch of Parameters with given in paper
